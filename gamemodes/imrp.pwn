...
#define LOCATION_SMUGGLERJOB 		2167.549,-1676.923,15.085
#define LOCATION_GETDRUGS 			323.280,1119.425,1083.882



new Float:DrugWarehouses[3][3] =
{
	{1614.104,-1892.817,13.277},
	{2464.271,-1424.402,23.75},
	{2746.439,-2002.584,13.554}
};
...
{
	{2073.442,-1913.442,13.281},
	{2117.876,-1896.961,13.074},
	{2221.3073,-1877.630,13.118},
	{2233.103,-1735.082,13.117},
	{2345.148,-1703.995,13.091},
	{2345.150,-1496.00,23.566},
	{2226.438,-1481.866,23.482},
	{2214.964,-1399.065,23.550},
	{2128.098,-1381.485,23.569},
	{2002.935,-1338.630,23.555},
	{1845.90,-1361.2,13.13},
	{1830.190,-1542.064,13.114},
	{1819.40,-1799.115,13.117},
	{1935.027,-1934.849,13.115},
	{2055.084,-1918.215,13.277}
};
...
new Float:HouseInterior[21][5] = {
	...
	{	318.57,		1115.105,	1083.882, 	0.0, 	5.0		}, // 14 Crack Den
...
public OnGameModeInit()
{
	...
	CreateDynamic3DTextLabel("Gas Station\nType /car refuel to refill your vehicle", COLOR_GOLD, 1944.529,-1769.265,13.382, 20.0);
	CreateDynamic3DTextLabel("Gas Station\nType /car refuel to refill your vehicle", COLOR_GOLD, 1944.529,-1776.255,13.382, 20.0);
	CreateDynamic3DTextLabel("Gas Station\nType /car refuel to refill your vehicle", COLOR_GOLD, 1938.423,-1776.255,13.382, 20.0);
	CreateDynamic3DTextLabel("Gas Station\nType /car refuel to refill your vehicle", COLOR_GOLD, 1938.423,-1769.265,13.382, 20.0);
...
public OnPlayerModelSelection(playerid, response, listid, modelid)
{
	if(listid == buyable)
	{
		...
		if(IsAVIPCar(modelid) && !IsPlayerVIP(playerid)) return SendClientMessageEx(playerid, COLOR_YELLOW, "This is a VIP vehicle. Please donate to get access to buy this vehicle.");
			...
			if(PlayerInfo[i][pJailTime] > 0)
			{
			    if(IsPlayerTabbed(i) == false)
			    {
					...
					if(PlayerInfo[i][pJailTime] == 1)
					{
						...
						SetPlayerPosEx(i, 1529.6,-1691.2,13.3);
...
CMD:gov(playerid, params[])
{
	...
	else SendClientMessageEx(playerid, COLOR_GREY, "You're not in a faction with access to this command.");
	return 1;
}
...
stock ShowPlayerStats(playerid, targetid)
{
	...
	format(string, sizeof(string), "Playing Hours: %i | Experience: %i/%d | Number: %i | Channel: %i kHz", PlayerInfo[targetid][pPlayingHours], PlayerInfo[targetid][pExperience], (PlayerInfo[targetid][pLevel] + 1) * 5, PlayerInfo[targetid][pPhoneNumber], PlayerInfo[targetid][pChannel]);
	SendClientMessageEx(playerid, COLOR_FADE1, string);
...
stock GetPlayerReferer(playerid)
{
	new
	    pName[MAX_PLAYER_NAME];
	if(!IsRPNameText(PlayerInfo[playerid][pReferer]))
		pName = "None";
	else
...
{
	return (IsPlayerInRangeOfPoint(playerid, 3.0, 1944.529,-1769.265,13.382) || IsPlayerInRangeOfPoint(playerid, 3.0, 1944.529,-1776.255,13.382)
			|| IsPlayerInRangeOfPoint(playerid, 3.0, 1938.423,-1776.255,13.382) || IsPlayerInRangeOfPoint(playerid, 3.0, 1938.423,-1769.265,13.382));
}
